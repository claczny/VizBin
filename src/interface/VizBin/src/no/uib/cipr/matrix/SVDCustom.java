...
public class SVDCustom {
     ...
     *            singular values
     */
    public SVDCustom(int m, int n, boolean vectors, boolean custom) {
        this.m = m;
        this.n = n;
        ...
        job = (vectors ? (custom ? JobSVD.Part : JobSVD.All) : JobSVD.None);
     ...
     */
    public static SVDCustom factorize(Matrix A) throws NotConvergedException {
        return new SVDCustom(A.numRows(), A.numColumns()).factor(new DenseMatrix(A));
    }
     ...
     * @throws NotConvergedException
     */
    public SVDCustom factor(DenseMatrix A) throws NotConvergedException {
        if (A.numRows() != m)
