...
public class MainFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tab_panel_visLayout.setHorizontalGroup(
            tab_panel_visLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 625, Short.MAX_VALUE)
        );
        tab_panel_visLayout.setVerticalGroup(
            tab_panel_visLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        panel_plugin_optionsLayout.setHorizontalGroup(
            panel_plugin_optionsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 360, Short.MAX_VALUE)
        );
        panel_plugin_optionsLayout.setVerticalGroup(
            panel_plugin_optionsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
...
//        tab_panel_plugins.getAccessibleContext().setAccessibleName("Plugins");
    ...
    private void button_processActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button_processActionPerformed
        ...
        if (processor == null || processor.getProcessEnded().get() == true ) {
            processor = new ProcessInput(indatafile, contigLen, numThreads, inpointsfile, inlabelsfile, kmer,
                    merge, pca, theta, perplexity, seed,
                    this.label_status, 
                    this.progBar, 
                    this.tabpanel, 
                    this, 
    ...
    private String getSelectedInputFile() {
        ...
        if (lastOpenPath != null) fc.setCurrentDirectory(lastOpenPath);
    ...
    private File getSelectedOutputFile(){
        ...
        if (fc.getSelectedFile() == null) return null;
          ...
          lastOpenPath = fc.getSelectedFile();
          if (fc.getSelectedFile().exists()) {
            returnVal = JOptionPane.showConfirmDialog(null, "The file you specified already exists, do you wish to overwrite it?","Confirm overwrite", JOptionPane.YES_NO_OPTION);
            if (returnVal != JOptionPane.YES_OPTION) return null;
    ...
    private void menu_file_reinitializeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menu_file_reinitializeActionPerformed
        Integer option = JOptionPane.showConfirmDialog(this, "Are you sure you want to reinitialize the settings?\n"
                + "This will recreate the config file and redeploy the OS-specific TSNE application.",
                "Confirm reinitialization", JOptionPane.YES_NO_OPTION);
    ...
    private void popOutVisWindow(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_popOutVisWindow
        if (DataSetUtils.isIsDataSetCreated()) {
            ...
            frame.getContentPane().add(new ClusterPanel(DataSetUtils.getDataSet(), indatafile, this, menu_options_drawaxes.isSelected()));
            frame.pack();
    ...
    private void exportVisToFile(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_exportVisToFile
        if (DataSetUtils.isIsDataSetCreated()) {
            ...
            try {
                ...
                if (outFile != null) ImageIO.write(bufferedImage, "png", outFile);
